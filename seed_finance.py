...
add('📖 [CURRENT] Essentials of Corporate Finance — Ross, Westerfield, Jordan', GREEN,
    'Chapter 11 completed (Risk & Return, Portfolio Variance). ~60% of bachelor-level foundation. Finish chapters 12-15 next.', 1)

# Phase 1: Sophomore/Junior
add('📘 Phase 1: Corporate Finance — Ross, Westerfield, Jaffe (Full Text)', BLUE,
    'The "big brother" to Essentials. Covers Capital Structure (MM Prop I & II), Dividend Policy, Advanced Valuation. Required before options/derivatives.', 1)

# Phase 2: Analyst Level
add('📘 Phase 2: Investment Banking — Rosenbaum & Pearl', ORANGE,
    'Valuation, LBOs, M&A. Teaches model building. The bible for IB/ER/PE entry-level roles.', 1)

# Phase 3: Associate Level
add('📘 Phase 3: Options, Futures & Other Derivatives — John Hull', ORANGE,
    'Portfolio variance → Beta → Hedging. Gold standard for pricing risk. Start with chapters 1-10.', 1)

# Phase 4: VP/Director Level
add('📙 Phase 4a: The Intelligent Investor — Benjamin Graham', ORANGE,
    'Value investing philosophy. How to think about intrinsic value vs. market price.', 1)

add('📙 Phase 4b: Thinking, Fast and Slow — Daniel Kahneman', ORANGE,
    'Cognitive biases in markets. Prospect theory, overconfidence, anchoring. Critical for behavioral finance.', 1)

add('📙 Phase 4c: The Alchemy of Finance — George Soros', ORANGE,
    'Reflexivity and macro thinking. How feedback loops move markets beyond fundamentals.', 1)

# Capstone
add('📕 Capstone: Active Portfolio Management — Grinold & Kahn', ORANGE,
    'PhD-level. Read first 3 chapters for the Fundamental Law of Active Management. α = IC × √BR × σ.', 1)
...
add('🟢 L1: Portfolio Variance & Covariance [YOU ARE HERE]', GREEN,
    ...
    'Key Q: Why does a negatively correlated asset reduce total risk even if volatile?', 1)
...
add('🟠 L5 Pillar: Corporate Finance', ORANGE,
    ...
    'High-level Q: "How do we finance a $1B acquisition without bankrupting the firm?"', 1)

add('🟠 L5 Pillar: Derivatives', ORANGE,
    'Black-Scholes, Greeks, Swaps.\n'
    'High-level Q: "How do we hedge fuel cost risk for an airline?"', 1)

add('🟠 L5 Pillar: Fixed Income', ORANGE,
    'Duration, Convexity, Credit Spreads.\n'
    'High-level Q: "If rates rise 1%, how much does our $10B bond portfolio lose?"', 1)

add('🟠 L5 Pillar: Macroeconomics', ORANGE,
    'Taylor Rule, Yield Curve, Carry Trade.\n'
    'High-level Q: "Is the Fed tightening? Should we be in cash or equities?"', 1)

add('🟠 L5 Pillar: Behavioral Finance', ORANGE,
    'Prospect Theory, Overconfidence, Herding.\n'
    'High-level Q: "The model says buy but everyone is selling. What is the real price?"', 1)
...
add('📅 Months 1-3: Quant Foundation', BLUE,
    ...
    'Book: Finish current book chapters 12-15.', 1)
...
add('📅 Months 4-6: Valuation Intensive', ORANGE,
    ...
    'Book: Rosenbaum & Pearl (Investment Banking).', 1)
...
add('📅 Months 10-12: Portfolio Manager Lite', ORANGE,
    ...
    'Book: Grinold & Kahn (first 3 chapters).', 1)
...
add('💡 The Meta-Skill', GREEN,
    ...
    'but expected return compensates. Here is the 5% worst-case scenario."', 1)
...
add('⚡ TODAY\'S ACTION', RED,
    ...
    'Do this and you are ahead of 80% of students.', 1)
